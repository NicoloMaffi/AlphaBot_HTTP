...
The API returns a dictionary with the key **status** and **right**.. A 0 value means that an obstacle has been detected by the sensor while a 1 value means that the sensor did not detected any obstacles.
